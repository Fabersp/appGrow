...
@interface ViewControllerTemp : UIViewController <UIPickerViewDataSource, UIPickerViewDelegate, UITextFieldDelegate> {
...
@property (weak, nonatomic) IBOutlet UILabel *TextoDe;
@property (weak, nonatomic) IBOutlet UILabel *TextoPara;
